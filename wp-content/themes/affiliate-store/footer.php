        ...
        <div class="footer-widget">
          ...
          <div class="row">
            ...
            <div class="<?php echo is_active_sidebar('footer-1') ? 'col-lg-3 col-md-6 col-12' : 'col-lg-3'; ?> footer-block">
              ...
              <?php else : ?>
                <aside id="calendar" class="widget py-3" role="complementary" aria-label="<?php esc_attr_e('footer1', 'affiliate-store'); ?>">
            ...
            <div class="<?php echo is_active_sidebar('footer-2') ? 'col-lg-3 col-md-6 col-12' : 'col-lg-3'; ?> footer-block">
              ...
              <?php else : ?>
                <aside id="meta" class="widget py-3" role="complementary" aria-label="<?php esc_attr_e('footer2', 'affiliate-store'); ?>">
            ...
            <div class="<?php echo is_active_sidebar('footer-3') ? 'col-lg-3 col-md-6 col-12' : 'col-lg-3'; ?> footer-block">
              ...
              <?php else : ?>
                <aside id="categories" class="widget py-3" role="complementary" aria-label="<?php esc_attr_e('footer3', 'affiliate-store'); ?>">
